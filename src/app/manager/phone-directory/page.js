...
export default function ManagerPhoneDirectoryPage() {
          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm mt-1">Quick access to firm contacts.</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 lg:col-span-1">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-white shadow-md shadow-blue-200 hover:shadow-blue-300 transition-all disabled:opacity-60"
                  style={{ background: 'linear-gradient(135deg, #2563eb 0%, #22c1c3 100%)' }}
                >
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {contacts.map((c) => (
                    <div
                      key={c._id}
                      className="rounded-2xl border border-slate-100 bg-gradient-to-r from-slate-50 to-blue-50 p-4 flex items-start justify-between gap-3"
                    >
