    ...
    <div className="min-h-screen bg-slate-50">
      <div className="pt-16 md:pl-64 transition-all duration-300 min-h-screen">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          ...
          {!loading && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 content-fade-in">
              <Link
                href="/superadmin/firms"
                className="block bg-white rounded-2xl border border-slate-100 shadow-sm p-6 hover:shadow-lg hover:border-amber-200 transition-all"
              >
