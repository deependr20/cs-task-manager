          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">
                Add CS practices. Each admin is assigned to one firm.
              </p>
            </div>
            <button
              type="button"
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 mb-6">
              ...
              <form onSubmit={handleAdd} className="flex flex-wrap gap-3">
                <input
                  ...
                  className="flex-1 min-w-[200px] px-4 py-2.5 rounded-xl border border-slate-200 text-slate-800"
                  required
                />
                <button
                  type="submit"
                  disabled={saving}
                  className="px-4 py-2.5 rounded-xl bg-amber-500 text-white font-semibold disabled:opacity-70"
                >
                  {saving ? 'Saving...' : 'Save'}
                </button>
                <button
            ...
            <div className="content-fade-in">
              {firms.length === 0 ? (
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-12 text-center text-slate-500">
                  No firms yet. Add a firm to assign admins.
                </div>
              ) : (
